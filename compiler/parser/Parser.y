...
inst_decl :: { LInstDecl GhcPs }
       ...
       {% do { (binds, sigs, _, ats, adts, _) <- cvBindsAndSigs (snd $ unLoc $4)
        ...
        | data_or_newtype 'instance' opt_unlifted capi_ctype tycl_hdr_inst constrs
                          maybe_derivings
        ...
        | data_or_newtype 'instance' opt_unlifted capi_ctype tycl_hdr_inst opt_kind_sig
                 gadt_constrlist
                 maybe_derivings
...
at_decl_inst :: { LInstDecl GhcPs }
        ...
        | data_or_newtype opt_instance opt_unlifted capi_ctype tycl_hdr_inst constrs maybe_derivings
               {% amms (mkDataFamInst (comb4 $1 $5 $6 $7) (snd $ unLoc $1) (snd $3) $4 (snd $ unLoc $5)
                                    Nothing (reverse (snd $ unLoc $6))
                                            (fmap reverse $7))
        ...
        | data_or_newtype opt_instance opt_unlifted capi_ctype tycl_hdr_inst opt_kind_sig
                 gadt_constrlist
                 maybe_derivings

...
dW_TAG_compile_unit, dW_TAG_subroutine_type,
  ...
  dW_TAG_ghc_core_note, dW_TAG_ghc_src_note :: Word
dW_TAG_array_type      = 1
...
dW_TAG_ghc_core_note   = 0x5b00
dW_TAG_ghc_src_note    = 0x5b01
...
-- Choose a more or less random section of the vendor-extensible region
dW_AT_ghc_core, dW_AT_ghc_span_file, dW_AT_ghc_span_start_line,
  dW_AT_ghc_span_start_col, dW_AT_ghc_span_end_line,
  dW_AT_ghc_span_end_col :: Word
-- These appear in DW_TAG_ghc_core_note DIEs
dW_AT_ghc_core            = 0x2b00     -- of type string
-- These appear in DW_TAG_ghc_src_note DIEs
dW_AT_ghc_span_file       = 0x2b10     -- of type string
dW_AT_ghc_span_start_line = 0x2b11
dW_AT_ghc_span_start_col  = 0x2b12
dW_AT_ghc_span_end_line   = 0x2b13
dW_AT_ghc_span_end_col    = 0x2b14

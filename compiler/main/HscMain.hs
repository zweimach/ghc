...
hscParse' mod_summary = {-# SCC "Parser" #-} withTiming getDynFlags "Parser" (const ()) $ do
    dflags <- getDynFlags
...
hscGenHardCode hsc_env cgguts mod_summary output_filename = do
        ...
        withTiming (pure dflags) "CodeGen" (const ()) $ do
...
hscParseThingWithLocation source linenumber parser str
  = withTiming getDynFlags "Parser" (const ()) $ {-# SCC "Parser" #-} do
    dflags <- getDynFlags

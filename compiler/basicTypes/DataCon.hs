...
instance Binary DataConRep where
  put_ bh r
    = case r of
        NoDataConRep  -> putByte bh 0
        DCR a _b c d e ->
          putByte bh 1 >> put_ bh a >> put_ bh c
                       >> put_ bh d >> put_ bh e
  get bh = do
    tag <- getByte bh
    case tag of
      0 -> pure NoDataConRep
      1 -> DCR <$> get bh <*> error "DataConBoxer (function) field"
...
instance Binary HsSrcBang where
  put_ bh (HsSrcBang a b c) = put_ bh a >> put_ bh b >> put_ bh c
...
instance Binary HsImplBang where
  put_ bh b
    = case b of
        HsLazy     -> putByte bh 0
        HsStrict   -> putByte bh 1
        HsUnpack a -> putByte bh 2 >> put_ bh a
  get bh = do
    tag <- getByte bh
    case tag of
      0 -> pure HsLazy
...
instance Binary StrictnessMark where
  put_ bh m
    = case m of
        MarkedStrict    -> putByte bh 0
        NotMarkedStrict -> putByte bh 1
  get bh = do
    tag <- getByte bh
    case tag of
      0 -> pure MarkedStrict
      1 -> pure NotMarkedStrict
...
instance Binary EqSpec where
  put_ bh (EqSpec tv t) = put_ bh tv >> put_ bh t
  get bh = EqSpec <$> get bh <*> get bh
...
instance Binary DataCon where
  put_ bh (MkData a b c d e f g h i j k l m n o p q r s t u v)
    = put_ bh a >> put_ bh b >> put_ bh c >> put_ bh d >> put_ bh e
   >> put_ bh f >> put_ bh g >> put_ bh h >> put_ bh i >> put_ bh j
   >> put_ bh k >> put_ bh l >> put_ bh m >> put_ bh n >> put_ bh o
   >> put_ bh p >> put_ bh q >> put_ bh r >> put_ bh s >> put_ bh t
   >> put_ bh u >> put_ bh v
  get bh
    = MkData <$> get bh <*> get bh <*> get bh <*> get bh <*> get bh

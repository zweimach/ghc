...
data CmmNode e x where
  ...
  CmmUnwind :: !GlobalReg -> !CmmExpr -> CmmNode O O
    ...
    -- Unwind pseudo-instruction, encoding stack unwinding Call Frame
  CmmUnwindCFA :: !CmmExpr -> CmmNode O O
...
mapExp f   (CmmUnwindCFA e)                      = CmmUnwindCFA (f e)
...
mapExpM f (CmmUnwindCFA e)          = CmmUnwindCFA `fmap` f e
...
foldExp f (CmmUnwindCFA e) z                      = f e z

...
PRELUDE_CLOSURE(base_GHCziIOziException_cannotCompactClosure_closure);
...
#define cannotCompactClosure_closure DLL_IMPORT_DATA_REF(base_GHCziIOziException_cannotCompactClosure_closure)

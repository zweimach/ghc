...
LocationBacktrace *libdw_my_cap_get_backtrace(void);
...
INLINE_HEADER LocationBacktrace *libdw_my_cap_get_backtrace(void) {
    return NULL;
}

INLINE_HEADER void libdw_my_cap_free(void) { }

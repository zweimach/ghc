...
/* A large (resp. compact) object which has been moved to off of
 * oldest_gen->large_objects (resp. compact_objects) and onto
 * nonmoving_large_objects (resp. nonmoving_compact_objects). The mark phase
 * ignores objects which aren't so-flagged. */

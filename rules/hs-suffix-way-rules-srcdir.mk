...
$1/$2/build/%.$$($3_osuf) : $1/$4/%.hc includes/dist/ghcautoconf.h includes/dist/ghcplatform.h | $$$$(dir $$$$@)/.
...
$1/$2/build/%.$$($3_osuf) : $1/$2/build/%.hc includes/dist/ghcautoconf.h includes/dist/ghcplatform.h
	$$(call cmd,$1_$2_CC) $$($1_$2_$3_ALL_CC_OPTS) $$(addprefix -I,$$(GHC_INCLUDE_DIRS)) -x c -c $$< -o $$@ $$(if $$(findstring YES,$$($1_$2_DYNAMIC_TOO)),-dyno $$(addsuffix .$$(dyn_osuf),$$(basename $$@)))
